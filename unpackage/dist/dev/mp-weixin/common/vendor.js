...
const pages = [
  ...
  {
    path: "pages/public/privacyPolicy",
    style: {
  ...
  {
    path: "pages/public/assist",
    style: {
      navigationBarTitleText: "问题及帮助",
      enablePullDownRefresh: false
    }
  },
  {
